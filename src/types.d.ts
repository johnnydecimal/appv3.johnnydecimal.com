 ...
 * pointless and probably just taking CPU cycles. We put some sample IDs
 * here to help us during development.
 */
...
//#region JdItem
/**
 * These are the items held by Userbase before they get parsed in to the
 * internal `JdSystem` object.
 *
...
type DatabaseMachineReactContextType = {
