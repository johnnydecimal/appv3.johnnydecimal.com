...
export const Breadcrumbs = () => {
  ...
  /** Nothing is selected. */
  if (!currentArea) {
    return <div className="border border-red">001 My first project</div>;
  }
  ...
  if (currentCategory && !currentId) {
    ...
    return (
      <div className="border border-red">
        001 ‣ {currentArea} ‣ {currentCategory} {categoryTitle}
      </div>
    );
  }
  ...
  if (currentId) {
    ...
    return (
      <div className="border border-red">
        001 ‣ {currentArea} ‣ {currentCategory} {categoryTitle} ‣ {currentId}{" "}
        {idTitle}
      </div>
    );
  }
